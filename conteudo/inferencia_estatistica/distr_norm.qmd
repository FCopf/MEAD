...
description: "Introdução à distribuição normal de probabilidades, características, aplicações e cálculo de probabilidades no contexto da inferência estatística."
Categories: ["Distribuição Normal", "Estatística Descritiva"]
...
```{r}
ie = read_delim("https://github.com/FCopf/datasets/raw/refs/heads/master/altura2022.csv")
```
...
A <a href="https://github.com/FCopf/datasets/blob/master/Tabela_Z.pdf" target="_blank">Tabela Z</a> disponibiliza os valores de probabilidade para um grande número de valores e é apresentada na grande maioria dos livros de estatística.
...
```{r}
rh <- read_delim('https://github.com/FCopf/datasets/raw/refs/heads/master/rhamdioglanis.csv', delim = ';',
