...
description: "Teorema central do limite e a distribuição das médias amostrais."
Categories: ["Teorema Central do Limite", "Inferência Estatística"]
...
![](img/amostragem_inferencia_1.png)
...
![](img/amostragem_inferencia_2.png)
...
> Note que o denomidador aqui é *diferente* do que fizemos no @sec-norm, pois aqui estamos falando da distribuição das **médias amostrais** $\overline{L}$ e não nas observações individuais $L$.
