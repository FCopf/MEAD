...
description: "Intervalos de confiança para estimar a média populacional, introdução à distribuição t de Student."
Categories: ["Intervalos de Confiança", "Inferência Estatística"]
...
Se queremos um nível de confiança diferente, basta ajustar o valor de $\alpha$. Por exemplo, se queremos um nível de significância a 99%, fixamos $\alpha$ em $0.01$ e portanto $z = 2.58$. Da mesma forma, o $IC_{90\%}$ poderá ser obtido com $\alpha = 0.10$ e consequentemente $z = 1.64$. Estes e outros limites descrevem as probabilidades em uma distribuição normal padronizada, que podem ser obtidos com o uso da maioria dos softwares estatísticos, além de estarem incluso na <a href="https://github.com/FCopf/datasets/blob/master/Tabela_Z.pdf" target="_blank">Tabela Z</a>, encontrada na grande maioria dos livros de estatística básica.
...
Para o cálculo do intervalo de confiança, assumimos que as médias amostrais seguem uma distribuição normal com média $\mu$ e desvio padrão $\frac{\sigma}{\sqrt{n}}$. Ao fazer isso, estamos aplicando o Teorema Central do Limite (TCL) (@sec-tcl). Geralmente, não temos os valores de $\mu$ e $\sigma$, por isso utilizamos os valores de $\overline{X}$ e $s$, calculados a partir de nossa amostra. Quando o tamanho das amostras é grande ($n \geq 30$), é aceitável utilizar o valor de $z_{\alpha/2}$. Assim::
