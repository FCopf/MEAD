...
$P(p) = `{python} lD_Hi_list[1]` \times \frac{1}{3} + `{python} lD_Hi_list[0]` \times \frac{1}{3} + `{python} lD_Hi_list[2]` \times \frac{1}{3}$

$P(p) = `{python} P_Hi_list[1]` + `{python} P_Hi_list[0]` + `{python} P_Hi_list[2]` = `{python} P_H_list`$
...
$P(p) = `{python} lD_Hi_list[1]` \times \frac{1}{8} + `{python} lD_Hi_list[0]` \times \frac{2}{8} + `{python} lD_Hi_list[2]` \times \frac{5}{8}$

$P(p) = `{python} P_Hi_inform_list[1]` + `{python} P_Hi_inform_list[0]` + `{python} P_Hi_inform_list[2]` = `{python} P_H_inform_list`$
