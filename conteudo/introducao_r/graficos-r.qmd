...
description: "Introdução à visualização gráfica no R: gráficos de barras, histogramas, boxplots, gráficos de dispersão e exportação de figuras."
categories: ["R", "Programação", "Gráficos em R", "Visualização de dados"]
