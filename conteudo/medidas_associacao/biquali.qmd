...
description: "Análise da associação entre variáveis qualitativas, tabelas de contingência e índice de qui-quadrado."
categories: ["Estatística", "Análise Qualitativa", "Tabelas de Contingência"]
...
```{r}
mun = read_delim('https://github.com/FCopf/datasets/raw/refs/heads/master/Entrevista_municipes.csv',
                  delim = ',')
