...
description: "Relação entre variáveis categóricas e contínuas, partição da soma dos quadrados, coeficiente de determinação"
categories: ["Estatística", "ANOVA", "Análise Quantitativa", "Análise Qualitativa"]
...
```{r}
medley = read_csv("https://github.com/FCopf/datasets/raw/refs/heads/master/medley.csv") |> 
