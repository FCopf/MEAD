...
description: "Relação entre variáveis quantitativas, covariância e correlação linear de Pearson."
categories: ["Estatística", "Análise Quantitativa", "Covariância", "Correlação"]
...
```{r}
tigre = read_delim('https://github.com/FCopf/datasets/raw/refs/heads/master/ctigre_haddon.csv')
