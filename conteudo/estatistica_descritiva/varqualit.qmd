...
description: "Exploração de variáveis qualitativas, incluindo categóricas ordenadas e não ordenadas, tabelas de frequência e representações gráficas com gráficos de barras."
categories: ["R", "Análise de Dados", "Estatística Descritiva", "Variáveis Qualitativas", "Visualização de Dados"]
...
#| output: false
res <- read_delim(
  file = "https://github.com/FCopf/datasets/raw/refs/heads/master/Reservatorios_Parana_parcial.csv",
  delim = ",",
