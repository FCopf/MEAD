...
description: "Transformação e interpretação do índice Z para padronizar distribuições, destacando sua relação com a média e o desvio padrão."
categories: ["R", "Análise de Dados", "Estatística Descritiva", "Padronização de Dados", "Índice Z"]
