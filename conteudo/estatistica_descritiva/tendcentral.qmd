...
description: "Cálculo e interpretação de medidas de tendência central, como média, mediana, moda e ponto médio, incluindo seu impacto em distribuições simétricas e assimétricas."
categories: ["R", "Análise de Dados", "Estatística Descritiva", "Tendência Central", "Distribuição de Dados"]
