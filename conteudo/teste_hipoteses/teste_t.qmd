...
description: "Comparando médias testes t para uma amostra, grupos independentes e medidas pareadas."
Categories: ["Comparação de Médias", "Testes de hipóteses"]
...
Na <a href="https://github.com/FCopf/amostragem-inferencia/blob/main/files/Tabela_t.pdf" target="_blank">Tabela t</a>, a primeira coluna mostra os *graus de liberdade* de $1$ a $120$. O cabeçalho da tabela de $90\%$ a $0,1\%$ mostra a área na distribuição de $t$ nas caldas inferior e superior.
